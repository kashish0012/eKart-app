...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputLayoutPassword = findViewById(R.id.register_password_textInput);
        textInputLayoutConfirmPassword = findViewById(R.id.register_confirm_password_textInput);
...
//            Toast.makeText(this, "Please write your password...", Toast.LENGTH_SHORT).show();
        ...
        {
            InputConfirmPassword.setError("Password Required");
...
//            Toast.makeText(this, "Please write your password...", Toast.LENGTH_SHORT).show();
        ...
        else if (password.length() < 7)
        {
            ...
            InputConfirmPassword.setError("Password does't match");
            InputConfirmPassword.requestFocus();
        }
        else {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful())
                                    {
                                        ...
                                        {
                                        loadingBar.dismiss();
                                        Toast.makeText(RegisterActivity.this, "Network issues: Please try again.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
